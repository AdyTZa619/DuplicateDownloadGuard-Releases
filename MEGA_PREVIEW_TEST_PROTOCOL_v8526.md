# MEGA Preview v8.5.27-test.1 — validare Windows
...
- URL-urile per-fișier sunt memorate, iar rutele vechi sunt curățate după repaus, nu în calea critică A → B → C.
- transferul HTTP anterior este anulat independent; Range/206 și T0–T12 rămân instrumentate.
